...
export default class Quat{
    ...
    public static fromEulerAngles(vector: Vec3): Quat {
    ...
    static rotateVector(q: Quat, v: Vec3): Vec3 {
        const qv = new Quat(v.x, v.y, v.z, 0);
        const qr = Quat.multiply(Quat.multiply(q, qv), Quat.conjugate(q));
